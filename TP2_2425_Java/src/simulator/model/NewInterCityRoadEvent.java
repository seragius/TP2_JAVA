...
public class NewInterCityRoadEvent extends Event {
    ...
    public NewInterCityRoadEvent(int time, String id, String src, String dest,
        ...
        if (id == null || src == null || dest == null || length <= 0 || co2Limit < 0 || maxSpeed <= 0 || weather == null)
            throw new IllegalArgumentException("Invalid parameters for NewInterCityRoadEvent");
    ...
    void execute(RoadMap map) {
        ...
        Road r = new InterCityRoad(id, j1, j2, maxSpeed, co2Limit, length, weather);
        map.addRoad(r);
    }
}
